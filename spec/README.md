...
- **Единая картина.** Все артефакты (спецификация, план, задачи, отчёты проверки) живут в одном месте и связаны между собой.
...
## Разница между Spec, Plan, Tasks и Verify в spec-flow

Путаница между этапами **spec**, **plan**, **tasks** и **verify** случается часто, поэтому давай разберём чётко:
