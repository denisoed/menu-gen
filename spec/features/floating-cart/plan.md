...
- В карточке блюда остановить всплытие клика с кнопки добавления (`@click.stop`), чтобы родительские ссылки или обработчики не перехватывали событие и не инициировали навигацию.
